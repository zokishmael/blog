...
!function JetThemeScript() {
    ...
    !function(i) {
        U[cH + bk](cm, function() {
            ...
            j < i && R(c4, "header-hidden") ? dj = b(function() {
                bU(c4, "header-hidden")
            }, 500) : i < j && R(c4, "header-animate") && (cD(dj),
            Q(c4, "header-hidden")),
            i = j
        }, !1)
    }(0);
    var M = function(dl) {
        ...
        "IMG" == dl[cd] && ((j = dl[bX + bg]("data-src"))[aU](/(bp.blogspot|googleusercontent)/) ? (dq = cy ? U[ch] && 1 < U[ch] ? U[ch] : 1.5 : 1,
        dp = (dl[cI] * dq)[aK](0),
        dn = (dl[a9][cI] * dq)[aK](0),
        dm = (dl[a9][a9][cI] * dq)[aK](0),
        i = (dl[cP] * dq)[aK](0),
        dj = j[bs]("/"),
        dk = j[t]("=") + 1,
        dq = "",
        dq = R(dl[a9], "ratio") ? "w" + dp + "-h" + i + "-c" + aG : "s" + (dq = dp < 30 ? dn < 30 ? dm : dn : dp) + aG,
        j = j[aU](/(img\/a|proxy\/)/) ? dk ? j[b2](0, dk) + dq : j + "=" + dq : j[L](dj[dj[c6] - 2], dq),
        dl[bB + bg]("data-src", j)) : j[aU](/(img.youtube|i.ytimg)/) && (j = j[bt](0, j[t]("/")) + "/mqdefault.jpg",
        dl[bB + bg]("data-src", j)))
    };
    if (0 < a[c6]) {
    ...
    var dc = function(dl) {
        ...
        function dk(dw, du, dt) {
            var i = a2[b9]("li")
              , dv = a2[b9]("span");
            return Q(dv, "btn btn-sm rounded-pill jt-icon-center"),
            dv[bv] = dt || dw,
            dv[bB + bg]("data-page", dw),
            dw == du ? Q(dv, "jt-btn-primary") : (Q(dv, "jt-btn-light hover-btn-primary"),
            dv[cH + bk](O, function(dy) {
                var dx;
                dy[cE](),
                1 == (dq = dv[bX + bg]("data-page")) ? (dx = dj ? aS + "/search" + dm + "?max-results=" + ds + "&page=" + dq : aS,
                U[bw][ah] = dx) : (dx = (dq - 1) * ds,
                Defer.js(aS + "/feeds/posts/summary/" + j + "?start-index=" + dx + "&alt=json&callback=jo." + k + "_date&max-results=1"))
            })),
            i[c7](dv),
            i
        }
        dl[bX + bg]("data-pagination") != F ? (ds = dl[bX + bg]("data-posts"),
        ...
        jo[k + "_" + bM] = function(dw) {
            ...
            if (ds < dt) {
                var dw = ab(dt, dq, dp, 5)
                  , i = a2[b9]("ul")
                  , du = dw.totalPages;
                1 != dw.currentPage && (dt = dk(dw.currentPage - 1, "", '<svg aria-hidden="true" class="jt-icon"><use xlink:href="#i-arrow-l"/></svg>'),
                i[c7](dt)),
                I(dw.pages, 1) || (dx = dk(1, dw.currentPage, "1 . ."),
                i[c7](dx));
                for (var dv = 0; dv < dw.pages[c6]; dv++) {
                    var dx = dk(dw.pages[dv], dw.currentPage);
                    i[c7](dx)
                }
                I(dw.pages, du) || (dx = dk(du, dw.currentPage, ". . " + du),
                i[c7](dx)),
                dw.currentPage != du && (du = dk(dw.currentPage + 1, "", '<svg aria-hidden="true" class="jt-icon"><use xlink:href="#i-arrow-r"/></svg>'),
                i[c7](du)),
                dl[bv] = "",
                Q(i, "pagination mb-0"),
                dl[c7](i),
        ...
        jo[k + "_date"] = function(i) {
            i = i.feed.entry[0],
            i = (i = i.published.$t[bt](0, 19) + i.published.$t[bt](23, 29))[L]("+", "%2B"),
        ...
        jo[p + "_" + bM + "_" + j] = function(dz) {
            ...
            if (0 < dD) {
                for (var dB = {
                    ...
                    var dE, dv, dy = du[dx], dA = dy.link[dy.link[c6] - 1][ah];
                    if (dw == dl) {
                        break
                    }
                    dA != i && (dw++,
                ...
                dz = U[dj];
                typeof dz === bJ && 0 < dB.posts[c6] && (ds && (dB.posts = c1(dB.posts)[b2](0, ds)),
                dn[bv] = dz(dB)[bp](),
                bU(dn, "visually-hidden"),
                Defer.dom(".lazy-" + j, 1, "loaded", M),
                !dr || typeof (dz = U[dr]) === bJ && dz())
            }
        }
    }
    ;
    ...
    da && da[cH + bk](O, function(i) {
        i[cE](),
        bR(bc, "dark-mode"),
        null !== bZ && bZ[bB + a4]("theme", R(bc, "dark-mode") ? "dark" : "light")
    }),
    U[cH + bk](cm, function() {
        (1 <= this[aR] && null !== c4 ? Q : bU)(c4, "shadow-sm"),
        (1000 <= this[aR] && null !== aF ? bU : Q)(aF, "d-none")
    }, !1),
    cX && cX[cH + bk](df, function(i) {
        bU(am, "loader")
    }),
    cj && cj[cH + bk](O, function(i) {
        i[cE](),
        Z(this[ah]),
        "add-comment" != am[a9][cN] && a2[E]("add-comment")[c7](am)
    });
    ...
    for (b7 = 0; b7 < cr[c6]; ++b7) {
        (bz = cr[b7])[cH + bk](ba, function(dk) {
            ...
            j[an] = function() {
                var dl;
                bU(dj, "loading"),
                4 === this[cK] && 200 === this[dh] && "" != this[cQ] && ((dl = aA(this[aP][bp]())) && "true" == dl.details.emailSentStatus ? (dj[K](),
                bU(dj, "send-error"),
                Q(dj, "send-success")) : (bU(dj, "send-success"),
                Q(dj, "send-error")))
            }
        })
    }
    ...
    function cA(i) {
        i = aA(i);
        i && i[bM] == cv && i[aX] == bd ? (dd("j" + bb, !0, 14),
        dd("j" + bM, b3, 14)) : h()
    }
    !function(j, i) {
        ...
        function j(dn, dm) {
            for (dn = 0; dn < i[c6]; ) {
                (dm = (dm = i[dn++])[aN] || dm)[aY + bk](a8, dm.md, 0),
                U[aY + bk](x, dm.mu, 0),
                U[aY + bk](cc, dm.mm, 0)
            }
            for (i = [][b2][ag](a2[v]("drag-scroll")),
            dn = 0; dn < i[c6]; ) {
                !function(ds, dr, dq, dt, du, dp) {
                    (dp = ds[aN] || ds)[cH + bk](a8, dp.md = function(dv) {
                        ds[bf + bg]("nochilddrag") && a2.elementFromPoint(dv[n], dv[m]) != dp || (dt = 1,
                        dr = dv[aC],
                        dq = dv[aB],
                        dv[cE]())
                    }
                    ...
                    U[cH + bk](cc, dp.mm = function(dv) {
                        dt && ((du = ds[aL] || ds)[aZ] -= dj = -dr + (dr = dv[aC]),
                        du[ce] -= dl = -dq + (dq = dv[aB]),
                        ds == a2[br] && ((du = a2._docElement)[aZ] -= dj,
                        du[ce] -= dl))
                    }
                    , 0)
                }(i[dn++])
    ...
    var bY = function(dl) {
        var dp = dl[bX + bg]("data-url") || "#"
          ...
          , j = 0
          , dl = cT("sf", a0);
        "#safelink" == dp && dl && (dp = U.atob(g(o(dl)))),
        intv = bl(function() {
            100 <= (j += dm) && (j = 100,
            di(intv),
            bU(dq, "disabled"),
    ...
    function e(ds) {
        ...
        a2[aY + bk](aj, e),
        a2[aY + bk](cm, e)),
        Defer.dom(".custom-posts", 1, null, jo[c2], null, {
            rootMargin: "200%"
        }),
        0 < P[c6]) {
            for (var dy = 0; dy < P[c6]; ++dy) {
                ...
                dv = a2[b9]("div");
                dv[bv] = j.value,
                0 == dy && Q(dv, "feature-image full-width"),
                dw[a9][cO + cf](dv, dw)
            }
        ...
        if (null !== cL) {
            if (null !== aV && null !== a1 && (a1[bv] = aV[bv],
            ...
            null !== aM) {
                ...
                for (var dt, dy = 0; dy < dz; dy++) {
                    dy == dz - 1 ? cL[c7](dn[0]) : (dt = dy == dz - 1 ? dk[c6] - 1 : cs[bP](dk[c6] / dz) * dy,
                    (dt = 0 == dy ? dk[0] : dk[dt][b6]) && dt[a9][cO + cf](dn[0], dt))
                }
            }
            if (bF && bF != F && ax && null !== cL[bW]) {
                ...
                null === ds ? ds = cL[bW] : ds[b6] && (ds = ds[b6]),
                0 < dq[c6] && (dm[bv] = ax(dq)[bp](),
                ds && ds[a9][cO + cf](dm, ds))
            }
        }
        db || (a3 && (!bV || bV == F || bV && bV != F && cW < b5) && (typeof adsbygoogle === dg && (adsbygoogle = []),
        Defer.js(cJ + "pagead2.googlesyndication.com/pagead/js/" + de + ".js?client=" + a3, de, 100)),
        D && D != F && Defer.js(cJ + "www.googletagmanager.com/gtag/js?id=" + D, b1, 100, function() {
            function i() {
                ...
                for (var dB = firebase.database(), dA = 0; dA < dD[c6]; dA++) {
                    ...
                    dC.once(aO, function(dF, dE) {
                        return function(dG) {
                            ...
                            0 < dG && (dF[bv] = dG,
                            bU(dF[a9], "d-none")),
                            dF[bX + bg]("data-increment") == bG && (dF[bB + bg]("data-increment", !1),
                            dG = y(dG) + 1,
                            dE.set(dG))
                        }
                    }(i, dC))
        ...
        bu && bu()),
        z && Defer.css(cJ + ak + "dyn-css/authorization.css?targetBlogID=" + z),
        0 < bO[c6] && Defer.js(cJ + "cdn.jsdelivr.net/npm/@splidejs/splide@3.6.12/dist/js/splide.min.js", "splide", 1, function() {
            new Splide(".splide")[d]()
        })
    }
    a3 && bV && bV != F && (U[aE](),
    ...
    ap && (a2[a5] = a2[a5][L](bL, bL + cz + " " + ap + bL)),
    Defer.dom(".lazyload", 1, "loaded", M),
    Defer.dom("#post-pager", 1, null, G, null, {
        rootMargin: "200%"
    }),
    ...
    cy ? e(!1) : (null !== bZ && bZ[bB + a4]("lazy", 1),
    a2[cH + bk](cc, e),
    a2[cH + bk](aj, e),
    a2[cH + bk](cm, e))
}();
